...
@RunWith(Cucumber.class)
@CucumberOptions(plugin= {"pretty","json:src/test/resources/Reports/cucumber.json"},features="src/test/resources",dryRun=false,monochrome=true,snippets=SnippetType.CAMELCASE)
	public class TestRunnerClasss extends BaseClass{
