...
public class BookingHotelStep extends BaseClass {
	...
	/*
	 * @Given("User Should Launch Browser") public void user_Should_Launch_Browser()
	 * throws IOException {
	 * 
	 * 
	 ...
	 * }
	 * 
	 * @When("User is on the Login Page") public void user_is_on_the_Login_Page()
	 * throws IOException { LoginPage loginPage = new LoginPage();
